  ...
  sections: [
    {
      index: 1,
      title: '我们为什么公开这份声明',
      body: 'GateRank 的职责，是把机场服务的公开监测结果、长期表现和风险信号整理成可解释的榜单，而不是替任何机场售卖名次。我们以平台管理人的身份明确说明：机场是否付费、付费多少、是否购买广告、是否提供优惠码，都不进入 GateRank Score，综合评分榜继续按原有评分规则排序。首页“GateRank 优秀机场”由符合付费入驻、充值、余额及节点条件的机场与管理员指定的已上架机场共同公平轮换；指定名单仅豁免轮换参与门槛，每轮各机场依次获得首位，展示顺序不代表评分高低，也不改变分数或扣费档位。',
    },
    {
      index: 2,
      title: '评估体系看什么',
