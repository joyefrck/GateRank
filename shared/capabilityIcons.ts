...
const capabilityIconMap: Record<string, CapabilityIconData> = {
  ...
  macau: { kind: 'flag', mark: '🇲🇴', color: '#15803d', bg: '#f0fdf4', border: '#bbf7d0' },
  ...
  indonesia: { kind: 'flag', mark: '🇮🇩', color: '#dc2626', bg: '#fff1f2', border: '#fecdd3' },
  thailand: { kind: 'flag', mark: '🇹🇭', color: '#4f46e5', bg: '#eef2ff', border: '#c7d2fe' },
  philippines: { kind: 'flag', mark: '🇵🇭', color: '#2563eb', bg: '#eff6ff', border: '#bfdbfe' },
  malaysia: { kind: 'flag', mark: '🇲🇾', color: '#2563eb', bg: '#eff6ff', border: '#bfdbfe' },
  vietnam: { kind: 'flag', mark: '🇻🇳', color: '#dc2626', bg: '#fff1f2', border: '#fecdd3' },
  australia: { kind: 'flag', mark: '🇦🇺', color: '#2563eb', bg: '#eff6ff', border: '#bfdbfe' },
  canada: { kind: 'flag', mark: '🇨🇦', color: '#dc2626', bg: '#fff1f2', border: '#fecdd3' },
  brazil: { kind: 'flag', mark: '🇧🇷', color: '#15803d', bg: '#f0fdf4', border: '#bbf7d0' },
  chile: { kind: 'flag', mark: '🇨🇱', color: '#dc2626', bg: '#fff1f2', border: '#fecdd3' },
  france: { kind: 'flag', mark: '🇫🇷', color: '#2563eb', bg: '#eff6ff', border: '#bfdbfe' },
  italy: { kind: 'flag', mark: '🇮🇹', color: '#15803d', bg: '#f0fdf4', border: '#bbf7d0' },
  netherlands: { kind: 'flag', mark: '🇳🇱', color: '#c2410c', bg: '#fff7ed', border: '#fed7aa' },
  south_africa: { kind: 'flag', mark: '🇿🇦', color: '#15803d', bg: '#f0fdf4', border: '#bbf7d0' },
  russia: { kind: 'flag', mark: '🇷🇺', color: '#2563eb', bg: '#eff6ff', border: '#bfdbfe' },
  spain: { kind: 'flag', mark: '🇪🇸', color: '#b45309', bg: '#fffbeb', border: '#fde68a' },
  switzerland: { kind: 'flag', mark: '🇨🇭', color: '#dc2626', bg: '#fff1f2', border: '#fecdd3' },
  sweden: { kind: 'flag', mark: '🇸🇪', color: '#2563eb', bg: '#eff6ff', border: '#bfdbfe' },
  finland: { kind: 'flag', mark: '🇫🇮', color: '#2563eb', bg: '#eff6ff', border: '#bfdbfe' },
  norway: { kind: 'flag', mark: '🇳🇴', color: '#dc2626', bg: '#fff1f2', border: '#fecdd3' },
  poland: { kind: 'flag', mark: '🇵🇱', color: '#dc2626', bg: '#fff1f2', border: '#fecdd3' },
  united_arab_emirates: { kind: 'flag', mark: '🇦🇪', color: '#15803d', bg: '#f0fdf4', border: '#bbf7d0' },
};
