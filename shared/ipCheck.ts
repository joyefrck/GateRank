...
export const IP_CHECK_TRANSLATIONS = {
  zh: {
    ...
    retry: '重试',
    dataSource: 'IP 数据由 ip-api Pro 提供，地图由 OpenStreetMap 与 CARTO 提供。',
    privacy: 'GateRank 不保存查询历史；ip-api Pro 会处理查询目标，并可能按其服务政策保留最多 24 小时的故障排查日志。',
  ...
  en: {
    ...
    retry: 'Retry',
    dataSource: 'IP data is provided by ip-api Pro. Map data is provided by OpenStreetMap and CARTO.',
    privacy: 'GateRank does not save lookup history. ip-api Pro processes lookup targets and may retain troubleshooting logs for up to 24 hours under its service policy.',
