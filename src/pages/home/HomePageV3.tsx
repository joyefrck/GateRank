...
function SponsoredEmptySlot({ slot }: { slot: SponsoredDeal['home_slot']; key?: React.Key }) {
  return (
    <RouteLink href="/apply" className="group relative flex min-h-[88px] flex-col items-center justify-center overflow-hidden rounded-[18px] border border-dashed border-gray-300 bg-gray-50/70 p-2.5 text-center transition-all hover:border-indigo-300 hover:bg-indigo-50/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-300 focus-visible:ring-offset-2">
