...
<html lang="zh-CN">
  <head>
    ...
    <style>
      ...
      h1{margin:0 0 12px;font-size:22px}p{margin:0;color:#475569;line-height:1.7}.fee{margin-top:18px;font-size:13px;color:#64748b}
    </style>
  </head>
  <body><main><h1>${escapeHtml(message)}</h1><p>该机场链接当前未开放跳转，请稍后再试或返回 GateRank 查看其他机场。</p><div class="fee">点击计费标准：¥${CLICK_CHARGE_AMOUNT.toFixed(2)} / 次</div></main></body>
</html>`;
}
