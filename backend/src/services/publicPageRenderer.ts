...
const styles = `
  * { box-sizing: border-box; }
  ...
  .home-v3-deal:active { transform: scale(.99); }
  ...
  @media (prefers-reduced-motion: reduce) { .home-v3-deal { transition: none; } .home-v3-deal:hover, .home-v3-deal:active { transform: none; } }
