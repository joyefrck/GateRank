CREATE TABLE IF NOT EXISTS airports (
  ...
  payment_crypto_other VARCHAR(255) NULL,
  has_annual_plan TINYINT(1) NULL DEFAULT NULL,
  has_telegram_group TINYINT(1) NULL DEFAULT NULL,
  telegram_allows_speaking TINYINT(1) NULL DEFAULT NULL,
  has_lifetime_plan TINYINT(1) NULL DEFAULT NULL,
  ...
  PRIMARY KEY (id),
  UNIQUE KEY uk_airports_slug (slug),
...
CREATE TABLE IF NOT EXISTS airport_metrics_daily (
  ...
  healthy_days_streak INT UNSIGNED NULL,
  is_stable_day TINYINT(1) NULL,
  stability_tier ENUM('stable', 'minor_fluctuation', 'volatile') NULL,
...
CREATE TABLE IF NOT EXISTS admin_scheduler_tasks (
  task_key ENUM('stability', 'subscription_node_refresh', 'performance', 'network_coverage', 'risk', 'aggregate_recompute', 'billing_listing_sync', 'stability_resample_guard', 'ad_expiry_reminder') NOT NULL,
  name VARCHAR(128) NOT NULL,
